...
void help( void ) {
  ...
  printf( "ma reports information from a maln assembly file as generated by ima\n" );
  ...
  printf( "     between consensus and reference sequence (see FORMATS, below)\n" );
  ...
  printf( "      the consensus assembly and the reference. Each row has the following\n" );
